...
public class TicketMasterAPI {
    ...
    private static final AWSSecretsManager secretsManager = AWSSecretsManagerClientBuilder.standard().build();
    private static final String API_KEY = secretsManager.getSecretValue(new GetSecretValueRequest().withSecretId(API_KEY_ARN)).getSecretString();
